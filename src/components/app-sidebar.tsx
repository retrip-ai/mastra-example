...
import { MoonIcon, SearchIcon, SunIcon, Trash2Icon } from 'lucide-react';
									...
									filteredThreads.map((thread) => (
										<SidebarMenuItem key={thread.id}>
											<SidebarMenuButton
												...
												render={<Link params={{ threadId: thread.id }} to="/chat/$threadId" />}
											>
				...
				<SidebarFooter className="p-2">
					<DropdownMenu>
						...
						>
							...
							<MoonIcon className="absolute ml-0 size-4 scale-0 rotate-90 transition-all dark:scale-100 dark:rotate-0" />
